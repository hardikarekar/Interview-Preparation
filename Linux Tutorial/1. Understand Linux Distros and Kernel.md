...
## What is Unix
* Unix is a powerful, multiuser, multitasking operating system originally developed in the 1970's at AT&T Bell Labs which serves as the foundation for many operating systems.
## Linux vs Unix
...
## Key Features
* Open Source: 
	* Source code is freely available and can be modified.
* Multiuser:
